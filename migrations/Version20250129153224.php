 ...
 */
final class Version20250129153224 extends AbstractMigration
{
    ...
    {
        // Créez une seule table de jointure
        ...
        // Modification dans la table 'commentaires_recette'
        $this->addSql('ALTER TABLE commentaires_recette CHANGE is_approved is_approved TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaires_recette CHANGE is_approved is_approved TINYINT(1) DEFAULT NULL');
    }
}
